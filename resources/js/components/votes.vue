<template>
    <div>
        <svg @click.prevent="vote('up')" class="thumbs-up" :class="{'thumb-up-active': upVoted}" width="20px" height="20px"
             version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
             viewBox="0 0 478.2 478.2" style="enable-background:new 0 0 478.2 478.2; margin-bottom: 5px;"
             xml:space="preserve">
            <g>
        ...
        <svg @click.prevent="vote('down')" class="thumbs-down" :class="{'thumb-down-active': downVoted}" width="20px" height="20px"
             version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
             viewBox="0 0 475.092 475.092"
             style="enable-background:new 0 0 475.092 475.092; margin-top: 2px; margin-left: 5px;"
             xml:space="preserve">
            <g>

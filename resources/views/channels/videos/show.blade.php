                    ...
                    @endif
                            ...
                            <div class="card-body ">
                                ...
                                <div class="d-flex row justify-content-between align-items-center">
                                    ...
                                    <div class="col-md-3 ">
                                        <div class="float-right">
                                            <svg class="thumbs-up" width="25px" height="25px"
                                                 version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                 viewBox="0 0 478.2 478.2" style="enable-background:new 0 0 478.2 478.2;"
                                                 xml:space="preserve">
                                                <g>
                                            ...
                                            <svg class="thumbs-down" width="25px" height="25px"
                                                 version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                ...
                                @if($video->editable())
                                    <hr>
                                    <div>
                                        <textarea class="form-control" name="description" id="description" cols="3" rows="4">{!! $video -> description !!}</textarea>
                                        @error('description')
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-2">
                                    <div class="media">
                                        ...
                                        <div class="media-body ml-2">
                                            <h5 class="mt-0 mb-0">
                                                <a href="{{ route('channels.show', $video -> channel -> id) }}" style="text-decoration: none; color: #000;">{{$video -> channel -> name}}</a>
                                            </h5>
                                            <span
